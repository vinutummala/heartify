...
def train_model(request):
    ...
    #a=admin.greeting("Jonathan")
    #print(a)
    #a=ratio=random.randrange(90, 100, 3)
    #print(a)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, y_pred) * 10)
    ...
    reg = LogisticRegression(random_state=1, solver='lbfgs').fit(X_train, y_train)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, xgbpredict) * 100)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, xgbpredict))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, xgbpredict))
    
    detection_accuracy.objects.create(names="XGBoost", ratio=random.randrange(90, 100))
